		...
		C11.7,31,11.9,31,12,31c0.4,0,0.8-0.2,0.9-0.6c2-4.7,3.3-9.7,3.9-14.9L17,14.1z"
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Rich history, legacy, and cultural significance of a brand,
                    which informs its identity and values, connecting past
                    traditions with present and future brand expressions.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <svg
                  ...
                  <span>
                    ...
                    Harmonious integration of all brand elements—such as logo,
                    typography, color palette, and messaging—creating a cohesive
                    and consistent visual and experiential identity across all
                    touchpoints.
                  </span>
                </li>
              </ul>
